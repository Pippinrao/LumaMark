> 语言：**中文** · [English](DEVELOPMENT_PROCESS.md)

> 本文档为中文版。英文默认版本位于仓库根目录 `DEVELOPMENT_PROCESS.md`；项目文档英文默认位于 `docs/`（无 `zh` 段，待补齐），中文镜像位于 `docs/zh/`。
...
1. **读取上下文**：阅读 `AGENTS.zh.md`、本文件、相关需求文档和已有代码。
...
- `docs/zh/decisions/`：架构和依赖决策
- `docs/zh/testing/`：测试策略和 fixture 说明
- `docs/zh/performance/`：性能基准和结果
- `docs/zh/product/`：产品定位、路线图、PRD
