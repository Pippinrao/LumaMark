...
>
> This document archives the Foundation / MarkText+ V1 scope and acceptance criteria. Do not use it to infer current implementation status or execution order. Current scope, sequencing, and exit gates live only in [Editor Reliability Implementation Plan](../roadmap/EDITOR_RELIABILITY_IMPLEMENTATION_PLAN.md).

## What this document was for

This was the Alpha product-requirements baseline for a daily-usable WYSIWYG Markdown editor. V1 prioritized a stable, fluent, trustworthy core writing path over feature breadth.
...
- **Shell UX:** WYSIWYG file-mode layout (menu bar; sidebar tabs for files/outline; single central editor); light/dark themes; settings; command palette; shortcuts.
