...
Dated 2026-07-05, this was the Alpha “version design” for LumaMark V1: not a commercial complete 1.0, but a stable MarkText+ / Alpha-to-Beta baseline—open Markdown, edit smoothly, basic WYSIWYG, Mermaid, source-faithful save, Windows-ready, with built-in Chinese and English.
...
4. **WYSIWYG** — layout, visuals, and basic live-preview behavior
